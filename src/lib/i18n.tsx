...
const translations: Record<string, Record<Language, string>> = {
  ...
  "q8-1.question": { en: "Which are signs of soil erosion? (Select all that apply)", rw: "Ni ibihe bimenyetso by'isuri? (Hitamo byose bikwiriye)" },
  "q8-1.0": { en: "Gullies", rw: "Imikoki" },
  "q8-1.1": { en: "Exposed roots", rw: "Imizi y'ibiti yanamye" },
  "q8-1.2": { en: "Bare soil", rw: "Ubutaka bwambaye ubusa" },
  "q8-1.3": { en: "Healthy crops", rw: "Ibihingwa bisa neza" },
  "q8-1.correct": { en: "Correct! These are visible signs of erosion.", rw: "Igisubizo cy'ukuri: Ibyo ni ibimenyetso bigaragara by'isuri." },
  "q8-1.incorrect": { en: "Incorrect. Healthy crops do not indicate erosion.", rw: "Ikitari ukuri: Ibihingwa bisa neza ntabwo ari ibimenyetso by'isuri." },

  "q9-1.question": { en: "Which is an erosion control measure?", rw: "Ni iyihe ngamba yo kurwanya isuri?" },
  "q9-1.0": { en: "Gullies", rw: "Imikoki" },
  "q9-1.1": { en: "Terraces", rw: "Amaterasi" },
  "q9-1.2": { en: "Sediment deposits", rw: "Ubutaka bwitekeye mu migezi" },
  "q9-1.3": { en: "Bare soil", rw: "Ubutaka bwambaye ubusa" },
